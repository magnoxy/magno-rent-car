        ...
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="mx-auto max-w-[700px] text-slate-400 md:text-xl">
              Alugue os melhores carros com facilidade e segurança. Experiência
              premium, preços justos e liberdade total.
            </p>
          </div>
          <div className="space-x-4">
            ...
            <Button
              size="lg"
              variant="outline"
              className="bg-slate-50 text-slate-950 hover:bg-green-500"
              asChild
            >
